        ...
        + '<div class="notepad-dlg-search">'
          + '<div class="dialogbox notepad-dlgbox">'
            ...
            + '<div class="main notepad-dlg-main">'
              ...
              + '<div class="capital"><label><input type="checkbox" value="capital-sense">区分大小写(C)</label></div>'
              + '<label><input type="checkbox" value="circulation">循环(R)</label>'
    ...
    function show(searchHandler) {
      ...
      $btnSearch.click(function() {
        searchHandler({
          ...
          circulation: $dlg.find('input[type="checkbox"]:checked').val() === 'circulation',
